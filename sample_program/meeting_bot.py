...
class MeetingBot:
    def __init__(self):
        ...
        self.deepgram_transcriber = DeepgramTranscriber(self)  # Pass the bot instance to DeepgramTranscriber
    ...
    def send_transcription_to_chat(self, transcription):
        ...
        builder.SetMessageType(zoom.SDKChatMessageType.To_Individual)  # You can also use To_All
        msg = builder.Build()
